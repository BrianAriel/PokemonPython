...
class GUI:
    ...
    def load_resources(self):
        player_gui = pygame.image.load("C:/Users/brian/PycharmProjects/PokemonPython/res/life_bar_player.png")
        ...
        enemy_gui = pygame.image.load("C:/Users/brian/PycharmProjects/PokemonPython/res/life_bar_enemy.png")
        size = enemy_gui.get_rect().size
        aspect_ratio = size[0]/size[1]
        enemy_gui = pygame.transform.scale(enemy_gui, (75 * aspect_ratio, 75))
        self.rendererEnemy = enemy_gui

    def render_hp_bar(self, game, bar_size, total_hp, actual_hp, position):
    ...
    def render_message(self, game, text):
    ...
    def render(self, game):
        ...
        self.render_hp_bar(game, 186, total_enemy_hp, game.pokemon2.current_hp, (112, 60))
        self.render_hp_bar(game, 180, total_player_hp, game.pokemon1.current_hp, (392, 304))
        ...
        if self.rendererEnemy:
            ...
            game.screen.blit(self.rendererEnemy, (20, 30))
